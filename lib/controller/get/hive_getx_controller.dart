...
class HiveGetXController extends GetxController {
  ...
  Future<bool> addToCart({required Product p}) async {
    Product product = Product(id: p.id,status: p.status,trend: p.trend,productNameEn: p.productNameEn,productNameAr: p.productNameAr,offer: p.offer,newProduct: p.newProduct);
